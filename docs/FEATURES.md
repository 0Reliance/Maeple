...
MAEPLE (Mental And Emotional Pattern Literacy Engine) emphasizes **context** and **understanding**. The goal is to help users recognize patterns over time and make the data easier to reflect on and share.

## 🎯 Gentle Onboarding

Your first experience with MAEPLE is thoughtfully designed:

### Onboarding Experience

- **5-Step Tutorial**: Walks you through what MAEPLE does and why it matters
- **User-Focused Messaging**: Each step emphasizes outcomes, not features
  - Step 1: "Understand Yourself Better" - Focus on self-compassion
  - Step 2: "See Your Patterns Clearly" - Focus on practical awareness
  - Step 3: "Meet Mae" - Your personal pattern analyst
  - Step 4: "Your Data Stays Yours" - Privacy-first approach
  - Step 5: "Your Pattern Journey Starts with One Entry" - Getting started
- **Skip Button**: Can exit anytime without guilt. You can replay it later from Settings
- **Replay Anytime**: Go to Settings → Help & Resources → Replay Onboarding Tutorial
- **Smart Detection**: Only shows for true first-time users, survives browser cache clearing

### Why This Matters

- No judgment, no pressure
- You control your learning pace
- Can explore the app without mandatory onboarding
- Can review content whenever you need a refresher

---

## 🧠 Neuro-Affirming Core

### Multi-Dimensional Capacity Grid

Instead of a single "1-10" energy scale, MAEPLE uses a **7-domain Capacity Grid** to track capacity across different domains:
...
### Capacity Metrics (The Lexicon)

We use precise language to describe your state:

- **Bandwidth**: Your available capacity in a domain.
- **Load**: The current demand placed on you.
- **Interference**: When one stressed system disrupts another (e.g., Sensory Overload → Emotional Crash).
- **Noise Generators**: Hidden costs like Masking or Perfectionism.

### The "Spoon" Theory Integration

Native support for "Spoon Theory" tracking, allowing you to visualize your daily energy expenditure and recovery.

---

## 📸 Bio-Mirror (AI Vision)

An optional photo-based check-in that can add structured context alongside self-report.

- **Scientific Foundation**: Uses the **Facial Action Coding System (FACS)** developed by Paul Ekman and Wallace Friesen to identify specific Action Units (AUs) associated with stress, fatigue, and emotional authenticity.

- **Enhanced FACS Detection (v0.97.6)**:
  - **Structured AU Codes**: Detects and reports specific Action Units (AU1, AU4, AU6, AU12, AU24, AU43, etc.)
  - **Intensity Ratings**: Each AU rated on scientific A-E scale (Trace to Maximum)
  - **Duchenne Smile Analysis**: Distinguishes genuine smiles (AU6+AU12) from social/posed smiles (AU12 alone)
  - **Masking Indicators**: Identifies when facial expression contradicts reported emotional state

- **Physiological Markers**:
  - **Fatigue**: AU43 (Eyes Closed), ptosis (lid droop), reduced overall expression
  - **Tension**: AU4 (Brow Lowerer), AU24 (Lip Pressor), AU14 (Dimpler)
  - **Authenticity**: AU6+AU12 combination for genuine vs. social smile detection
  - **Masking**: Compares Zygomatic Major (Smile) vs. Orbicularis Oculi (Eye crinkle) to distinguish "social" smiles from authentic ones.
- **Privacy**: Bio-Mirror photos and results are stored locally by default. Cloud sync does not upload Bio-Mirror history. If you enable AI analysis, the captured image is sent to the selected provider for processing.
...
Multi-mode journaling supports **pattern literacy**:
...
## 🎙️ Mae Live Companion

A real-time, voice-first AI companion designed for neurodivergent processing.

- **Verbal Processing**: Talk through your day, feelings, or blocks without needing to type.
- **Neuro-Affirming Persona**: "Mae" is trained to validate, not fix. She understands masking, burnout, and sensory needs.
- **Live Transcript**: See what you say and what Mae says in real-time bubbles.
- **Save to Journal**: One-tap save of your entire session transcript to your journal for future reflection or analysis.
- **Multimodal**: Uses Gemini 2.0 Flash Exp for low-latency voice and text interaction.
...
- **System-Wide Dark Mode**: Fully optimized for low-light environments to reduce sensory load.
- **High Contrast Options**: For better readability.
- **Screen Reader Friendly**: Built with semantic HTML and ARIA labels.
