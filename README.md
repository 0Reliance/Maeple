...
> _v2.0.0 | Multi-provider AI | PWA-Ready | Cloud Sync | Part of Poziverse_

---

## 📚 Documentation

- **[System Architecture](specifications/SYSTEM_ARCHITECTURE.md)**: Tech stack, patterns, and structure.
- **[API Reference](specifications/API_REFERENCE.md)**: Internal services and external integrations.
- **[Data Models](specifications/DATA_MODELS.md)**: Database schema and types.
- **[UI/UX Guidelines](specifications/UI_UX_GUIDELINES.md)**: Theming, components, and accessibility.
- **[Master Plan](specifications/MASTER_PLAN.md)**: Current development status and sprint plans.
- **[Roadmap](specifications/ROADMAP.md)**: Future vision and completed phases.
- **[Changelog](specifications/CHANGELOG.md)**: Version history.
...
MAEPLE now uses a multi-provider AI router (Gemini 2.5 + OpenAI live; Anthropic/Perplexity/OpenRouter/Ollama/Z.ai fully integrated) to track multi-dimensional capacity, predict burnout trajectories, and provide context-aware coaching with graceful fallback.
...
- **AI Intelligence**:
  - Multi-provider router: Gemini, OpenAI, Anthropic, Perplexity, OpenRouter, Ollama, Z.ai fully integrated
  ...
  - `llama-3.1-sonar` (Perplexity Search)
