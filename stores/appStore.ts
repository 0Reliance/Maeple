...
import { getEntries, saveEntry, deleteEntry, getUserSettings, saveUserSettings } from '../services/storageService';
      ...
      (set, get) => ({
        ...
        initialize: async () => {
          ...
          try {
            ...
            const onboardingComplete = localStorage.getItem('maeple_onboarding_complete') === 'true';
